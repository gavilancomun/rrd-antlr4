...
/**
 * The workhorse of this little library: it parses the ANTLR 4 grammar, and
 * invokes the JavaScript library that translates the DSL produces by the ANTLR
 * parser to a SVG.
 *
 * Through this class you can also create an html page containing railroad
 * diagrams of all parsed rules and create individual png images from one (or
 * more) grammar rules.
 */
...
/**
 * Creates a new instance of this class and will parse the provided
 * `antlr4Grammar`.
 *
 * @param antlr4Grammar the ANTLR 4 grammar to parse. It can be a remote- or
 * local file
 *
 * @throws IOException when the grammar could not be parsed.
 */
...
/**
 * Returns a map containing all parser- and lexer rules mapped to the DSL
 * `railroad-diagram.js` uses to translate to SVG-railroad diagrams.
 *
 * @return a map containing all parser- and lexer rules mapped to the DSL
 * `railroad-diagram.js` uses to translate to SVG-railroad diagrams.
 */
 ...
 *
 * @param ruleName the grammar rule to get the SVG railroad diagram from.
 *
 ...
 *
 * @param ruleName the grammar rule to create a PNG image from.
 *
...
/**
 * create pdf file based on png images which are generated by provided grammar
 * rule
 *
 ...
 *
 * @param fileName the name of the html page.
 *
 ...
 *
 * @param fileName the file name of the generated html page.
 *
 * @return `true` iff the creation of the html page was successful.
 */
 ...
 *
 * @param input the input to convert into a String.
 *
...
/**
 * Returns an HTML template containing SVG text-tags that will be wrapped with
 * '<a xlink:href=...' to make the grammar rules clickable inside the HTML page.
 *
 * @param fileName the name og the parsed grammar.
 * @param template the template whose text-tags need to be linked.
 *
 * @return an HTML template containing SVG text-tags that will be wrapped with
 * '<a xlink:href=...' to make the grammar rules clickable inside the HTML page.
 */
